          ...
          child: AnimatedBuilder(
            ...
            builder: (context, child) => Container(
              decoration: BoxDecoration(
                ...
                border: isNumber
                    ? Border.all(color: Colors.black, width: 2) // Borde negro para los números
                    : Border.all(color: Colors.black, width: 2), // Borde negro para los iconos
                boxShadow: [
                  BoxShadow(
      ...
      children: symbols.map((symbol) {
        return _buildButton(
          symbol == "C"
              ...
              : symbol == "="
                  ? Text("=", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white))
                  : (symbol == "/" || symbol == "x" || symbol == "-" || symbol == "+")
                      ? Icon(icon, color: Colors.white, size: 28)
                      : Text(symbol, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
          symbol == "C" || symbol == "=" ? Colors.blue[400]! : Colors.red[400]!,
          symbol,
          isNumber: RegExp(r'^[0-9]$').hasMatch(symbol), // Verifica si es número
        );
      }).toList(),
    );
  }
